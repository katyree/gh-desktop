    ...
    string? ComparisonReference)
{
        ...
        out string? error)
    {
        ...
        if (view is not ("changes" or "history" or "settings" or "branches" or "worktrees" or "stashes" or "remotes" or "tags"))
        {
            error = "--view must be changes, history, settings, branches, worktrees, stashes, remotes, or tags.";
            return false;
        }
