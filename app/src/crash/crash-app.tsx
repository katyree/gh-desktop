...
const issuesUri = 'https://github.com/katyree/gh-desktop/issues'
...
export class CrashApp extends React.Component<ICrashAppProps, ICrashAppState> {
  ...
  private renderTitle() {
    const message =
      this.state.type === 'launch'
        ? 'WinGit failed to launch'
        : 'WinGit encountered an error'
  ...
  private renderDescription() {
    if (this.state.type === 'launch') {
      return (
        <p>
          WinGit encountered a catastrophic error that prevents it from
          launching. This has been reported to the team, but if you encounter
          this repeatedly please report this issue to the WinGit{' '}
      ...
      return (
        <p>
          WinGit has encountered an unrecoverable error and will need to
          restart. This has been reported to the team, but if you encounter this
          repeatedly please report this issue to the WinGit{' '}
          <LinkButton uri={issuesUri}>issue tracker</LinkButton>.
        </p>
      )
    }
