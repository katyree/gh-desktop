...
export const applicationThemes: ReadonlyArray<ApplicationThemeDefinition> = [
  ...
  },
  {
    ...
    nativeThemeSource: 'dark',
    classNames: ['theme-dark', 'theme-custom-dark', 'theme-nord'],
  },
  {
    kind: 'fixed',
    ...
    nativeThemeSource: 'dark',
    classNames: ['theme-dark', 'theme-custom-dark', 'theme-monokai-pro'],
  },
  {
    kind: 'fixed',
    ...
    nativeThemeSource: 'dark',
    classNames: ['theme-dark', 'theme-custom-dark', 'theme-one-dark'],
  },
  {
    kind: 'fixed',
    theme: ApplicationTheme.Dracula,
    label: 'Dracula',
    preview: 'ghd_dracula.svg',
    nativeThemeSource: 'dark',
    classNames: ['theme-dark', 'theme-custom-dark', 'theme-dracula'],
  },
  {
    kind: 'fixed',
    theme: ApplicationTheme.TokyoNight,
    label: 'Tokyo Night',
    preview: 'ghd_tokyo_night.svg',
    nativeThemeSource: 'dark',
    classNames: ['theme-dark', 'theme-custom-dark', 'theme-tokyo-night'],
  },
  {
    kind: 'fixed',
    theme: ApplicationTheme.CatppuccinMocha,
    label: 'Catppuccin Mocha',
    preview: 'ghd_catppuccin_mocha.svg',
    nativeThemeSource: 'dark',
    classNames: ['theme-dark', 'theme-custom-dark', 'theme-catppuccin-mocha'],
  },
  {
    kind: 'fixed',
    theme: ApplicationTheme.GruvboxDark,
    label: 'Gruvbox Dark',
    preview: 'ghd_gruvbox_dark.svg',
    nativeThemeSource: 'dark',
    classNames: ['theme-dark', 'theme-custom-dark', 'theme-gruvbox-dark'],
  },
  {
    kind: 'fixed',
    theme: ApplicationTheme.Graphite,
    label: 'Graphite',
    preview: 'ghd_graphite.svg',
    nativeThemeSource: 'dark',
    classNames: ['theme-dark', 'theme-custom-dark', 'theme-graphite'],
  },
  {
    kind: 'fixed',
    ...
    nativeThemeSource: 'dark',
    classNames: ['theme-dark', 'theme-custom-dark', 'theme-amoled'],
  },
]
