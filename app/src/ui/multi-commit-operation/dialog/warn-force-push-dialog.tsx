      ...
      >
        <DialogContent>
          ...
          <p id="warn-force-push-confirmation-message">
            At the end of the {operation.toLowerCase()} flow, WinGit will enable
            you to force push the branch to update the upstream branch. Force
            pushing will alter the history on the remote and potentially cause
            problems for others collaborating on this branch.
          </p>
          <div>
            <Checkbox
